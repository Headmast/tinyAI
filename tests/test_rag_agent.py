...
from rag.answer_comparison import build_comparison, compare_all, print_comparison_report
...
class TestAskWithRag:
    def test_returns_expected_keys(self):
        ...
        assert set(result.keys()) == {
            "answer", "sources", "chunks_used", "token_usage", "elapsed_ms", "mode"
        }
...
class TestCompare:
    ...
    def test_both_modes_called(self):
        ...
        agent.ask_without_rag.assert_called_once_with("q")
        agent.ask_with_rag.assert_called_once_with("q")
